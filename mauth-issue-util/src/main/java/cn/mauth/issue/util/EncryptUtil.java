...
public class EncryptUtil {
     ...
     * @return 加密后的字符串
     */
    public static String encrypt(String xmlStr,String encryKey) {
        ...
        try {
            ...
            byte[] key = new byte[8];
            byte[] iv = new byte[8];
            EncryptUtil.getKeyIV(encryKey, key, iv);
     ...
     * @return 秘钥
     */
    public static String decrypt(String xmlStr,String encryKey) {
        // 使用DES算法解密
        String result = null;
        try {
            // base64解码
