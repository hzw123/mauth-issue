...
<div class="bjui-pageHeader">
	<form id="pagerForm" data-toggle="ajaxsearch" action="${base}/admin/orderSupply/list" method="post">
		...
		<div class="bjui-searchBar">
            ...
            <br />
            <br />
            <a href="${base}/admin/orderSupply/add" class="btn btn-default" data-toggle="dialog" data-icon="plus" data-id="orderSupply-add" data-options="{title:'添加', height:500}">添加 </a>
		</div>
	</form>
</div>
