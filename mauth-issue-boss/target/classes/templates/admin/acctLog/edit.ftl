...
<div class="bjui-pageContent">
	<form action="${base}/admin/acctLog/update" data-toggle="validate" method="post">
		...
		<div class="form-group">
            ...
            <input type="text" name="gmtCreate" value="${(bean.gmtCreate?string('yyyy-MM-dd HH:mm:ss'))!}" placeholder="" size="20">
        </div>
		<div class="form-group">
            <label class="control-label x85">修改时间：</label>
            <input type="text" name="gmtModified" value="${(bean.gmtModified?string('yyyy-MM-dd HH:mm:ss'))!}" placeholder="" size="20">
        </div>
		<div class="form-group">
