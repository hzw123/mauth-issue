...
<div class="bjui-pageContent">
	<form action="${base}/admin/acctInfo/update" data-toggle="validate" method="post">
		...
		<div class="form-group">
            <label class="control-label x85" title="1 正常 2 冻结 9注销">状态：</label>
		...
		<div class="form-group">
            ...
            <input type="text" name="lastTradeDate" value="${(bean.lastTradeDate?string('yyyy-MM-dd HH:mm:ss'))!}" placeholder="最后交易时间" size="20">
        </div>
		<div class="form-group">
