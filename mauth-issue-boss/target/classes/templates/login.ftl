...
<head>
    ...
    <title>储值卡管理平台-欢迎登录</title>
    <link href="${base}/BJUI/plugins/bootstrap/3.3.7/css/bootstrap.min.css" rel="stylesheet" />
...
<body >
    ...
    <div style="background-color: #358de7;">
        <div class="container">
            <div class="row">
                <div class="col-md-8"><img src="${base}/BJUI/login/images/bg.JPG" style="width:100%;"></div>
                <div class="col-md-3" style="background-color:#fff;margin:80px 0;padding:30px 25px;">
                    <form class="form-signin" action="${base}/login" method="post">
                        ...
                        <button class="btn btn-lg btn-primary btn-block" type="button" onclick="location='/sso'">SSO登录</button>
                    </form>
                </div>
            </div>
        </div>
    ...
    <div style="background-color:#fff; width:100%;margin:50px auto;text-align:center;">Copyright &copy; <span id="y"></span>储值卡管理平台 </div>
