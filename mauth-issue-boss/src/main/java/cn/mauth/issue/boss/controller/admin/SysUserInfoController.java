...
import cn.mauth.issue.boss.service.SysUserInfoService;
...
public class SysUserInfoController extends BaseController {
	...
	public void lookupUser(@RequestParam(value = "pageCurrent", defaultValue = "1") int pageCurrent, @RequestParam(value = "pageSize", defaultValue = "10") int pageSize, @ModelAttribute SysUserInfoQO qo, ModelMap modelMap) {
	...
	public void list(@RequestParam(value = "pageCurrent", defaultValue = "1") int pageCurrent, @RequestParam(value = "pageSize", defaultValue = "10") int pageSize, @ModelAttribute SysUserInfoQO qo, ModelMap modelMap) {
