...
import cn.mauth.issue.boss.service.SysLogOptService;
...
public class SysLogOptController extends BaseController {
	...
	public void list(@RequestParam(value = "pageCurrent", defaultValue = "1") int pageCurrent, @RequestParam(value = "pageSize", defaultValue = "10") int pageSize, @ModelAttribute SysLogOptQO qo, ModelMap modelMap){
