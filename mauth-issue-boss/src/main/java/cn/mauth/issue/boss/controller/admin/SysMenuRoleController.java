...
import cn.mauth.issue.boss.service.SysMenuRoleService;
...
public class SysMenuRoleController extends BaseController {
	...
	public void setGet(@ModelAttribute SysMenuRoleQO qo, ModelMap modelMap) {
		...
		List<SysMenuVO> menuList=sysMenuService.listMenuForRole(list, qo.getPlatformId());
		SessionUtils.setMenuAndRole(menuList);
		sysRoleUserService.setAdmin(ConfigUtil.PLATFORM_APPID);
