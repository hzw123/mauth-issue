...
public class SysPlatformController extends BaseController {
	...
	public void list(@RequestParam(value = "pageCurrent", defaultValue = "1") int pageCurrent, @RequestParam(value = "pageSize", defaultValue = "10") int pageSize, @ModelAttribute SysPlatformQO qo, ModelMap modelMap){
